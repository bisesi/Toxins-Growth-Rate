# ATB
# supp figure 6
# levy correlations with islands
...
suppfigure6 <- plot_grid(top, bottom, ncol = 1)

png(here::here("figures", "final-figs", "imgs", "supp-figure-6.png"), res = 300, width = 4800, height = 3000)
suppfigure6
dev.off()
