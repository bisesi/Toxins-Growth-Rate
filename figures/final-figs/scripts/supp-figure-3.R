...
#final figure
suppfigure3 <- plot_grid(partA, partB, partC, ncol = 3, labels = c("A", "B", "C"), label_size = 26)

png(here::here("figures", "final-figs", "imgs", "supp-figure-3.png"), res = 300, width = 3000, height = 1000)
suppfigure3
dev.off()
