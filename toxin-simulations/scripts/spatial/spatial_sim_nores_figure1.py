...
for i in expanded_grid.index.values:
    ...
    ## Make the layout
    l = c.layout(susceptible_models + producer_models)
    l.grid = grid_size
...
total_biomass_data.to_csv("/Users/abisesi/Desktop/PhD/Projects/Toxins-Growth-Rate/toxin-simulations/simulations_spatial/total_biomass_nores.csv")
metabolite_data.to_csv("/Users/abisesi/Desktop/PhD/Projects/Toxins-Growth-Rate/toxin-simulations/simulations_spatial/metabolites_nores.csv")
starting_locations.to_csv("/Users/abisesi/Desktop/PhD/Projects/Toxins-Growth-Rate/toxin-simulations/simulations_spatial/starting_locations_nores.csv")
