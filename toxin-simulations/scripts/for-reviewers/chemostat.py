...
parameter_dict = {'growth_rate': growth_rates, 'production_cost': production_costs, 
                  ...
                  'replicate': replicates, 'space_widths': space_width_starts, 'with_death': with_death}
...
for i in expanded_grid.index.values:
    ...
    dilution_rate = expanded_grid.at[i, 'dilution_rate']
    base_hours = 1 
    death = expanded_grid.at[i, 'with_death']
    ...
    if death == True:
        ...
        p.set_param("deathRate", dilution_rate)
        p.set_param("metaboliteDilutionRate", dilution_rate)
    ...
    l.grid = grid_size
    l.set_specific_refresh("carbon_e", 4.e-7 * dilution_rate)
    ...
    biomass_total["dilution_rate"] = dilution_rate
    biomass_total["with_death"] = death

    metabolites = sim.media
    metabolites["growth_rate"] = growth_rate
    metabolites["spatial_seed"] = spatial_seed
    metabolites["dilution_rate"] = dilution_rate
    metabolites["with_death"] = death
    ...
    spatial_data["dilution_rate"] = dilution_rate
    spatial_data["with_death"] = death

    starting_locations = pd.concat([starting_locations, spatial_data])

    print(i + 1, "of", max(expanded_grid.index.values) + 1)

total_biomass_data.to_csv("/Users/abisesi/Desktop/PhD/Projects/Toxins-Growth-Rate/toxin-simulations/for_reviewers/total_biomass_chemostat.csv")
metabolite_data.to_csv("/Users/abisesi/Desktop/PhD/Projects/Toxins-Growth-Rate/toxin-simulations/for_reviewers/metabolites_chemostat.csv")
starting_locations.to_csv("/Users/abisesi/Desktop/PhD/Projects/Toxins-Growth-Rate/toxin-simulations/for_reviewers/starting_locations_chemostat.csv")
