...
grid_size =[100, 100] # this was 100x100 in the actual sims!
...
growth_rates = [1.]
space_widths = [0.002, 0.004, 0.008]
...
base = f"/Users/abisesi/Desktop/PhD/Projects/Toxins-Growth-Rate/toxin-simulations/rep_{replicate}_spatial.seed_{spatial_seed}_growthrate_{growth_rate}_spacewidth_{space_width}/"
...
locs = pick_unique_locations(grid_size[0], grid_size[1], 100, 3)
...
#sim.set_classpath('bin', '/panfs/jay/groups/0/harcombe/harcombe/comets/bin/comets_multitoxin.jar')
try:
